...
create or replace table raw_data.empl(EmplNo integer not null,EmployeeName varchar(40),SSN varchar(40),StartDate DATE,Email varchar(40));
ALTER TABLE raw_data.empl RENAME TO raw_data.Employees1;   